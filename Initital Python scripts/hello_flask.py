#from flask package import Flask module
...
@app.route("/createJIRA", methods=['POST']) #route decorator to map the URL '/' to the hello function
def createJIRA():
...
app.run('0.0.0.0', port = 5000) #run the Flask application
